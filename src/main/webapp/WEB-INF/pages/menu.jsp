    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="/list">Депутаты</a></li>
                <li><a href="/party">Партии</a></li>
                <li><a href="/hotornot">Индекс доверия</a></li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/laziest">Пассивные депутаты</a></li>
                        <%--<li><a href="#">Непопулярные депутаты</a></li>--%>
                        <li><a href="/hotornot/antirating">Наименьший индекс доверия</a></li>
                    </ul>
                </li>
            </ul>
